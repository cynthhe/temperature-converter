 ...
 * Submission Date:
 *
 * Purpose: The program does the following: prompts the user to enter a temperature in Fahrenheit
 * and a temperature scale the user wants to convert it to. If both the temperature in Fahrenheit to
